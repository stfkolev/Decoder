...
namespace Decoder.Option
{
    public class Utils
    {
        ...
        public static void WriteToConsole(string Text, ConsoleColor color = ConsoleColor.Gray, bool bNewLine = false)
        {
            lock (console_lock)
            {
        ...
        {
            WriteToConsole("This tool is published by Stf Kolev");
